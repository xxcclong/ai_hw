...
file2 = open('model2_cut_300000.json','r')
file1 = open('part_one_model.json','r')
file_th = open('model3_cut_3000000.json','r')
...
rules = [[file_names[1], '0.5', '0.4','0'],
        ...
        [file_names[1],'0.9','0.05','0'],
        [file_names[1],'0.95','0.025','0'],
#        [file_names[1],'0.9','0.1','0'],
        [file_names[1],'0.4','0.1','1'],
        [file_names[1],'0.6','0.1','1'],
        [file_names[1],'0.8','0.1','1']]
print('provided')
print('cut 3000000 and 300000')
for rule in rules:
    filej = open(rule[0],'r')
